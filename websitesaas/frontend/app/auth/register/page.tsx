    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-24">
        <div className="w-full max-w-md p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800">
          <h1 className="text-2xl font-bold mb-6 text-zinc-900 dark:text-zinc-50">Create Account</h1>
          <form className="space-y-4">
            <div>
              <label className="block text-sm font-medium mb-2 text-zinc-700 dark:text-zinc-300">Name</label>
              <input type="text" className="w-full px-4 py-2 rounded-lg border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-900" placeholder="Your name" />
            </div>
            <div>
          ...
          <p className="mt-4 text-sm text-center text-zinc-600 dark:text-zinc-400">
            Already have an account? <a href="/auth/login" className="text-zinc-900 dark:text-zinc-100 font-medium">Sign in</a>
          </p>
        </div>
      </main>
    </div>
