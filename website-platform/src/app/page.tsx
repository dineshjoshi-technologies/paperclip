    ...
    <div className="flex flex-col min-h-screen bg-white dark:bg-black">
      ...
      <nav className="w-full border-b border-zinc-200 dark:border-zinc-800">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link href="/" className="font-bold text-xl text-zinc-900 dark:text-zinc-100">DJ Technologies</Link>
          <div className="flex items-center gap-6">
            ...
            <a href="#contact" className="text-sm text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100">Contact</a>
            <Link href="/login" className="text-sm text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100">
              Sign In
            </Link>
            <Link href="/register" className="bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 px-4 py-2 rounded-full text-sm font-medium hover:bg-zinc-800 dark:hover:bg-zinc-200 transition-colors">
              Get Started
            </Link>
          </div>
        </div>
      ...
      <main className="flex-1">
        <section className="max-w-6xl mx-auto px-6 py-24 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 px-8 py-3 rounded-full font-medium hover:bg-zinc-800 dark:hover:bg-zinc-200 transition-colors">
              Start Building Free
            </button>
        ...
        <section id="pricing" className="max-w-6xl mx-auto px-6 py-24">
          ...
          <div className="max-w-md mx-auto p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 text-center">
            ...
            <button className="w-full bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-900 py-3 rounded-full font-medium hover:bg-zinc-800 dark:hover:bg-zinc-200 transition-colors">
              Get Started
            </button>
          </div>
        </section>
